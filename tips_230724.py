...
class Correlation:
    ...
    def regplot_corr(self,df,correlations):
        """
        

        Args:
            correlations (_type_): unstackした、level_0とlevel_1が含まれて、0にvalueが格納されているDataFrame
        """
        ...
        for row in range(0,16,2):
            ...
            # sns.regplot(df, x=a, y=b, ci=False, ax=axes[i], order=1, 
            #             scatter_kws={'color':'red', 's':1.5}, 
